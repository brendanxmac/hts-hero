...
export const sendTariffImpactCheckExampleEmail = async (recipient: string) => {
  const html = tariffImpactCheckEmailHtml();
  const text = tariffImpactCheckEmailText();

  await sendEmail({
    to: recipient,
    subject: `🚨 New Tariffs Affect 6 of your Imports [Fake Example]`,
    text,
    html,
        ...
        <div class="alert-section">
          ...
          <div class="impact-summary">
            <div class="summary-item">
              ...
              <span class="summary-value">Fake Tariff Announcment</span>
            </div>
            <div class="summary-item">
              <span class="summary-label">Your Import List</span>
              <span class="summary-value">Fake Import List</span>
            </div>
            <div class="summary-item">
              <span class="summary-label">Imports Affected</span>
              <span class="summary-value">
                <span class="affected-count">6 imports</span>
              </span>
            </div>
          </div>
          
          <div class="cta-section">
            <a href="https://htshero.com/tariffs/impact-checker" class="cta-button">
...
Tariff Announcement: Fake Tariff Announcement
Your Import List: Fake Import List
Imports Affected: 6 imports

View Affected Imports: https://htshero.com/tariffs/impact-checker
