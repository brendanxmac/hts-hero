...
export const chinaTariffs: TariffI[] = [
  ...
  },
  {
    ...
    exceptions: [
      ...
      // "9903.88.67", // inactive
      // "9903.88.68", // inactive
      "9903.88.69", // Deactivates November 29, 2025
    ],
    inclusions: {
      countries: ["CN"],
      codes: [
  ...
  },
  {
    ...
    name: "Articles the product of China from 20 (c) and (d) (Section 232)",
    general: 25,
    special: 0,
    other: 0,
    exceptions: [
      ...
      // "9903.88.67", inactive
      // "9903.88.68", inactive
      "9903.88.69", // deactivates Nov 29, 2025
      "9903.88.70", // deactivates Nov 29, 2025
    ], // Deactivates November 29, 2025
    inclusions: {
      countries: ["CN"],
      codes: [
        "2710.19.30",
  ...
  },
  {
    ...
    inclusions: {
      countries: ["CN"],
      // 20(www)
      codes: ["8486.10.00.00", "8486.20.00.00", "8486.40.00.30"],
    },
  },
  {
    code: "9903.91.01",
