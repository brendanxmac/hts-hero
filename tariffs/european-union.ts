...
export const europeanUnionTariffs: TariffI[] = [
  {
    ...
    name: "Articles of the European Union Exempt from Reciprocal Tariff listed in Ch.99, U.S. note 2(v)(xvi)",
    general: 0,
    special: 0,
    other: 0,
    inclusions: {
  ...
  },
  {
    ...
    name: "Non-patented Articles for Use in Pharmaceutical Applications of the European Union listed in Ch.99, U.S. note 2(v)(xix)",
    general: 0,
    special: 0,
    other: 0,
    requiresReview: true,
  ...
  },
  {
    ...
    name: "EU Reciprocal Tariff (When General Duty >= 15%)",
    general: 0,
    special: 0,
    other: 0,
    exceptions: [
