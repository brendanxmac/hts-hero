...
import { ToolsDropdown, MobileToolsMenu } from "@/components/ToolsDropdown";
...
const cta: JSX.Element = <ButtonSignin extraStyle="btn-primary md:btn-sm" />;
    ...
    <>
      <header className="bg-base-200">
        <nav className="max-w-7xl flex items-center justify-between px-8 py-3 mx-auto">
          ...
          <div className="hidden lg:flex lg:justify-end lg:flex-1 gap-2 items-center">
            {cta}
            <ThemeToggle />
          </div>
        </nav>
