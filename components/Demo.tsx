...
const Demo = ({
  ...
  return (
    <section className="bg-none max-w-6xl mx-auto min-h-[90vh] bg-base-100 px-4 sm:px-6 md:px-8 lg:px-12 py-12 sm:py-16 md:py-20 flex flex-col items-center justify-center">
