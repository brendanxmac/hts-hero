...
// TODO: Would it make sense to include the overall summary of the tariff in the tariff
//  or should we just keep every tariff simple and rely on the linking and look ups?
// For example, including which codes exclude this given tariff -- we could take the sum
// of the linked tariff exclusions and put that inside the base tariff, OR we could leave
// each set of codes in the linked tariff and always get the codes via lookup & join or
// just one by one lookup
// Same with countries.... kind of
  ...
  },
  {
    ...
    exceptions: [
      ...
      },
      {
        ...
        name: "Loaded, Entered, or Withdrawn from Warehouse Date Range Criteria",
        general: 0,
        special: 0,
        other: null,
      },
